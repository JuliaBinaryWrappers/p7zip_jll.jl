...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import p7zip_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("3f19e933-33d8-53b3-aaab-bd5110c3b7a0"))
...
if best_platform === nothing
    @debug("Unable to load p7zip; unsupported platform $(triplet(platform_key_abi()))")
else
